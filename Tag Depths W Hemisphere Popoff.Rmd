...
##Read in data.
```{r}
Depths_234816 <-read.csv(file="C:/R_git_stuff/Mobula-tag-depths/234816-Series.csv", header=TRUE, sep=",")
...
```{r}
brett_depth_plot_good_label_yaxis(Depths_234816, "Etc/GMT+11", "Tag ID 234816", x_label = "Date/time (HST - 1) hr)", ylims = c(400, 0))
